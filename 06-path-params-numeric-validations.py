...
# http://127.0.0.1:8000/items2/0
# http://127.0.0.1:8000/items2/1
# http://127.0.0.1:8000/items2/2
# http://127.0.0.1:8000/items2/4
...
# 对于 lt 也是一样的。
# http://127.0.0.1:8000/items3/1?size=0
# http://127.0.0.1:8000/items3/1?size=0.5
# http://127.0.0.1:8000/items3/1?size=10.5
